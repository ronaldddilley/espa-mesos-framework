...
def main():
    ...
    input_files = glob.glob('/data2/dilley/input-data/bridge/*')

    with open('bridge-template.json', 'r') as template_fd:
    ...
    for input_file in input_files:
        ...
        input_url = 'file:///home/espa/input-data/bridge/{}'.format(basename)
    ...
    with open('bridge-jobs.json', 'w') as jobs_fd:
